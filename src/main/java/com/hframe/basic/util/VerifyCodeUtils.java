...
public class VerifyCodeUtils{  
	...
	public static final void getVerifyCode(Integer... param){
		...
		SessionUtils.setSessionAttribute(RootUtils.CHECK_CODE, SecurityUtils.MD5.getMD5(verifyCode.toUpperCase()));
		HttpServletResponse response = SessionUtils.getResponse();
		try {
			VerifyCodeUtils.outputImage(width, heigth, response.getOutputStream(), verifyCode);
		} catch (IOException e) {
